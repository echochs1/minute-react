...
/**
 * Function that takes in an audioUrl created by the AssemblyAI API POST request of an audio file.
 * Returns an "id" from AssemblyAI API JSON that can be processed by getTranscript.js.
 * @param {*} audioUrl - a URL that can be used for transcription by the AssemblyAI API.
 */
